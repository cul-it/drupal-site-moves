...
REMOTE_SITE_MOVES_DIRECTORY=/libweb/drupal/${REMOTE_SITE_NAME}/drupal-site-moves/${REMOTE_USER}
...
LOCAL_SITE_MOVES_DIRECTORY=/libweb/drupal/${LOCAL_SITE_NAME}/drupal-site-moves/${LOCAL_USER}
