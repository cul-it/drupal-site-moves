...
REMOTE_SITE_MOVES_AREA=/libweb/drupal/backups/drupal-site-moves/${REMOTE_SITE_NAME}
...
LOCAL_SITE_MOVES_AREA=/libweb/drupal/backups/drupal-site-moves/${LOCAL_SITE_NAME}
