...
REMOTE_SITE_MOVES_DIRECTORY=/tmp/drupal-site-moves/${REMOTE_SITE_NAME}/${REMOTE_USER}
...
LOCAL_SITE_MOVES_DIRECTORY=/tmp/drupal-site-moves/${LOCAL_SITE_NAME}/${LOCAL_USER}
